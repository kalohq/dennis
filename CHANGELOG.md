...
- Release v0.10.0 
  ([@yannispanousis](https://github.com/yannispanousis/)
  in [\#57](https://github.com/lystable/dennis/pull/57/))



## [v0.10.0](https://github.com/lystable/dennis/tree/v0.10.0) (Unreleased)

[Compare to previous release](https://github.com/lystable/dennis/compare/v0.9.1...v0.10.0)

**Added**:

- Release v0.9.1 
  ([@yannispanousis](https://github.com/yannispanousis/)
  in [\#55](https://github.com/lystable/dennis/pull/55/))
...
- Use the target_commitish parameter of the GitHub API to specify 
  ([@yannispanousis](https://github.com/yannispanousis/)
  in [\#51](https://github.com/lystable/dennis/pull/51/))
- Release v0.8.3 
  ([@yannispanousis](https://github.com/yannispanousis/)
  in [\#50](https://github.com/lystable/dennis/pull/50/))
